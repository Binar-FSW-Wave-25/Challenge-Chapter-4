...
class Gameplay extends Setting {
  ...
  matchResult() {
    if (this.getIsRule() === "win") {
      console.log(`player: ${this.player} com: ${this._com} | player juara`)
    } else if (this.getIsRule() === "lose") {
      console.log(`player: ${this.player} com: ${this._com} | com juara`);
    } else {
      console.log(`player: ${this.player} com: ${this._com} | seri`)
    }
    return this.winner;
  }
}
...
function pleaseReset() {
  alert("Klik logo restart dan Oke");
}
function resetGame() {
